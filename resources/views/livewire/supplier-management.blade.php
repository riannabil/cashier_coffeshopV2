<div>
    ...
    <div class="mb-6 flex items-center justify-between">
        <h2 class="text-2xl font-semibold text-gray-900">Manajemen Supplier</h2>
                            ...
                            <tr>
                                ...
                                <td class="whitespace-nowrap px-6 py-4 text-right text-sm font-medium">
                                    ...
                                    <button wire:click="delete({{ $supplier->id }})"
                                        wire:confirm="Anda yakin ingin menghapus supplier '{{ $supplier->name }}'?"
                    ...
                    <div class="space-y-6 bg-white p-6">
                        ...
                        <div>
                            ...
                            <input type="text" id="name" wire:model.defer="name"
                                ...
                                placeholder="Misal: PT. Kopi Sejahtera">
                            @error('name')
                        ...
                        <!-- Kontak Person -->
                        <div>
                            <label for="contact_person" class="block text-sm font-medium text-gray-700">Kontak Person
                                (Opsional)</label>
                        ...
                        <!-- Telepon -->
                        <div>
                            <label for="phone" class="block text-sm font-medium text-gray-700">Telepon
                                (Opsional)</label>
